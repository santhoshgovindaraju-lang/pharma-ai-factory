...
st.markdown("""
    ...
    h2 { color: #1e293b; font-family: 'Helvetica Neue', Arial, sans-serif; font-weight: 700; border-bottom: 2px solid #f1f5f9; padding-bottom: 0.5rem; margin-top: 1.5rem; }
...
# =========================================================================
    ...
    sc0, sc1, sc2, sc3 = st.tabs(["Scenario 1: Standalone Open HTML", "Scenario 2: Client Platform Mandate", "Scenario 3: Legacy Manual Code", "Scenario 4: Platform Migration Factory"])
    with sc0:
        ...
        st.markdown("* **The Scale Benefit:** The compiler automatically applies relative typography rules and fluid CSS grids, ensuring the asset scales across every single iPad resolution and version without breaking or overlapping headings.")
    with sc1:
        ...
        st.markdown("* **The Scale Benefit:** Bypasses hours of manual asset dragging and dropping. Our **AI Template Engineers** handle platform-specific layout bugs directly within their software workspace, and validation scripts scrape live preview links for exact PDF visual checks.")
    with sc2:
        ...
        st.markdown("* **The Scale Benefit:** The clean components are automatically re-compiled into our modern, fluid layout core—upgrading the legacy asset to support responsive screen sizes and current device requirements in minutes.")
    with sc3:
        ...
        st.markdown("* **The AI Intervention:** The wrapper acts as a structural translator. It uses **Pluggable Deployment Adapters** to separate the core visual content layer from the legacy platform's system files.")
        st.markdown("* **The Scale Benefit:** The engine automatically strips away outdated tracking configurations and dynamically appends modern analytics tags tailored to their new CRM endpoints, transforming a massive migration bottleneck into an automated, high-margin assembly line.")
